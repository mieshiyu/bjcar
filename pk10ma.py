...
class pk10ma():
    ...
    def DataProcessing(self, NO_Pmlist, last_MA5_xiadan_duo, last_MA5_xiadan_kong,
        ...
        if trader_time < time(10, 00) or trader_time > time(23, 48):
            ...
            # 2.0 统计空信号失败次数
            # 2.1 生成下单盈亏比照列表
            print(last_MA5_xiadan_duo, last_MA5_xiadan_kong, NO_Pmlist)
            ...
            print(MA_kong, MA_duo, self.duo_win, self.kong_loss, self.godlike)
            # 3.2 根据盈亏次数判断
            # 3.3 空失败 >= 3
            if MA_kong >= 3:
                print(1.1)
            ...
            if self.xiadan_list_duo == [] and self.xiadan_list_kong == []:
                pass
            else:
                print(self.xiadan_list_duo, 'duo', self.xiadan_list_kong, 'kong')
